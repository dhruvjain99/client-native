...
This project contains structs and validation methods that are autogenerated using [go-swagger](https://github.com/go-swagger/go-swagger) from the swagger specification found [here](https://github.com/dhruvjain99/client-native/blob/master/specification/build/haproxy_spec.yaml).These structs are also used in the [DataPlaneAPI](http://github.com/haproxytech/dataplaneapi)
...
```go
//import cfg_opt "github.com/dhruvjain99/client-native/v5/configuration/options"
...
// runtime
// import runtime_options "github.com/dhruvjain99/client-native/v5/runtime/options"
nbproc := 8
...
// import "github.com/dhruvjain99/client-native/v5/options"
opt := []options.Option{
